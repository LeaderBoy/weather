...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (_menuDelegate && [_menuDelegate respondsToSelector:@selector(selectMenuAtIndex:andView:)]) {
        [_menuDelegate selectMenuAtIndex:indexPath.item andView:collectionView];
    }
